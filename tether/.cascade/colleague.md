...
- 2026-09-08 05:4x UTC: main 4b75dd4 (PR 465 silence hook) on all 8 gateways, doctors clean. Code work for moves 1–2 is complete.
- Next: C4 eval on or after 2026-09-10 05:30 UTC (48 h of traffic on the final stack): export 48 h of #agent-hub, measure, judge with rubric v2, compare to baseline-2026-09-06 (answered 1.86 lane 1.71 evidence 1.71 tone 1.43; status lines 1, leaks 1, extra voices 3). Then: decision on trimming `tether setup` machinery to reach < 3,000 lines; Codex app-server driver (turn/start with MCP disabled) as the next code item. C4 after 48 h of traffic (from 2026-09-08). Also: docs/plans + scripts/fleet now live on main via PR 458; this branch keeps only .cascade/.
