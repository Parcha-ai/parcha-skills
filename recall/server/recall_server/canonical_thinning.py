...
def _compact_event_expression(alias: str = "event") -> str:
    ...
    provenance = (
        ...
        f"'native_conversation',NULLIF(jsonb_strip_nulls(jsonb_build_object("
        f"'conversation_id',{alias}.canonical_redacted #> '{{provenance,native_conversation,conversation_id}}',"
        f"'strand_id',{alias}.canonical_redacted #> '{{provenance,native_conversation,strand_id}}')),'{{}}'::jsonb),"
