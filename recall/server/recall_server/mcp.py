...
ALL_READ_TOOLS = (
    ...
    },
    {
        ...
        "description": (
            ...
            "`duckdb` CLI is on PATH. Do not pass `-readonly` or `--readonly`: "
            "the temporary in-memory catalog must be writable while Recall already "
            "mounts every evidence dataset read-only. Start planning with "
