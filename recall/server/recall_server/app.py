...
class Handler(BaseHTTPRequestHandler):
    ...
    def metrics(self) -> bytes:
        ...
        lines = [
            ...
            "# HELP recall_passage_duplicate_rows Canonical passage rows whose text repeats an earlier row of the same tenant.",
            "# TYPE recall_passage_duplicate_rows gauge",
            f"recall_passage_duplicate_rows {db.get('passage_duplicate_rows', 0)}",
            "# HELP recall_document_records_p99 99th percentile of records per logical evidence document.",
            "# TYPE recall_document_records_p99 gauge",
            f"recall_document_records_p99 {db.get('document_records_p99', 0)}",
