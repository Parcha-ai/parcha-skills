...
AGENT_MAP_GUIDANCE = (
    ...
    "candidate or its plausible candidates were inspected. A partition may "
    "include several entities when that avoids an unnecessary cross-product. Do not keep the "
