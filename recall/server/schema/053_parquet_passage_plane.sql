...
-- extant source/month exactly once. The projector can retain immutable v1 evidence
-- objects while adding passages; ordinary changed projections still replace stale
-- objects through the normal cleanup queue.
